...
namespace Loserhub\Library\Auth;

use Loserhub\Backend\Models\Users;
use Phalcon\Mvc\User\Component;
use Loserhub\Backend\Models\SuccessLogins;
use Loserhub\Backend\Models\RememberTokens;
use Phalcon\Logger;
...
class Auth extends Component
{
    ...
    public function check($credentials)
    {
        ...
        /*
        $logger = new FileAdapter(BASE_PATH . '/storage/logs/test.log');
     ...
     *
     * @param \Loserhub\Backend\Models\Users $user
     * @throws Exception
     */
     ...
     *
     * @return \Loserhub\Backend\Models\Users
     * @throws Exception
     */
