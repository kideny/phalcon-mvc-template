            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form action="/backend/members/edit" role="form" autocomplete="off" method="post">
                            <div class="box-body">
                                <div class="form-group col-sm-12">
                                    <?php echo $form->render("isVip"); ?>
                                ...
                                <div class="form-group col-sm-12">
                                    ...
                                    <label for="isActivated">是否激活会员</label>
                                </div>
                            </div>
                            <div class="box-footer">
                                <div class="form-group col-sm-6">
                                    <button type="submit" class="btn btn-primary">立即保存</button>
                                    <button type="submit" class="btn btn-default">保存和关闭</button>
                                    <span class="btn-text">
