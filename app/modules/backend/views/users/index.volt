                        ...
                        <div class="box-header with-border">
                            <div class="box-title">
                                <a href="/backend/users/create" class="btn btn-primary">
                                    <i class="fa fa-fw fa-plus"></i> 新管理员
                                </a>
                                <a href="/backend/usergroups/index" class="btn btn-primary">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {% endif %}
                                        <td>
                                            <a href="/backend/users/edit?id={{ user.id }}">编辑</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                            <a href="/backend/users/changepassword?id={{ user.id }}">修改密码</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                            <a href="/backend/users/delete?id={{ user.id }}">删除</a>
                                        </td>
                                    </tr>
                                    {% endfor %}
                                </tbody>
